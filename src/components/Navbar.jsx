    ...
    return (
        <nav className="fixed w-full z-50 bg-[#16151a] border-b border-gray-800 shadow-lg">
            <div className="container mx-auto px-6 h-24 flex justify-between items-center">
                ...
                {/* Search Bar (Desktop) */}
                <div className="hidden lg:flex items-center bg-white rounded-full flex-1 mx-4 max-w-[420px] py-1.5 pl-4 pr-1.5 shadow-xl hover:shadow-orange-500/5 transition cursor-pointer gap-2">
                    <input
                        type="text"
