...
const SearchResults = () => {
    ...
    }, [allProperties, operation, location, propertyType, currency, priceMin, priceMax, bedrooms, bathrooms, sortBy]);
    ...
    const activeFilterCount = [operation, location, propertyType, priceMin, priceMax, bedrooms, bathrooms].filter(Boolean).length;
